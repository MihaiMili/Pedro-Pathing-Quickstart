...
@Config
@Autonomous(group = "Auto", name = "5+1 maybe")
public class RightAuto extends LinearOpMode {
    ...
    public static double limit_spit[] = {0.7,0.6,0.75};
...
//        Pose parkPose = new Pose(11,30,parkAngle);
        ...
        Pose color2CollectPose = new Pose (30,27,color2CollectAngle);
        Pose color3CollectPose = new Pose(29,19,color3CollectAngle);
        ...
        Pose specimen2CollectPose = new Pose(10,35,specimenCollectAngle);
        Pose specimen3AlignPose = new Pose(26.5,42,specimenCollectAngle);//27 42
        Pose specimen3CollectPose = new Pose(10,35,specimenCollectAngle);
        Pose specimen4AlignPose = new Pose(26.5,42,specimenCollectAngle);
        Pose specimen4CollectPose = new Pose(10,35,specimenCollectAngle);
        ...
        Path park = new Path(new BezierLine(new Point(sampleScorePose2),new Point(parkPose)));
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            switch (status)
            {
                ...
                case PARK:
                {
                    ...
                    if (timer_park.seconds() > 29.8) RightAutoController.CurrentStatus2 = RightAutoController.autoControllerStatus.PARK;
                    break;
                }
            }
