...
@Config
@Autonomous(group = "Auto", name = "LeftAutoBlue")
public class LeftAutoBlue extends LinearOpMode {
    ...
    public static double yellow3Angle = Math.toRadians(20);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!okAuto)
        {
            ...
            if (!previousGamepad1.cross && currentGamepad1.cross) okAuto= true;
            ...
            telemetryA.addLine("x when ready");
            telemetryA.update();
        }
        /**
         * POSES
        ...
        Pose yellowPose1 = new Pose(21.5,135.5,yellow1Angle);
        Pose yellowPose2 = new Pose(20.3,136,yellow2Angle);
        Pose yellowPose3 = new Pose(20.3,136,yellow3Angle);
        ...
        Pose summersibleCollectPose1 = new Pose(75+poscnt,99,collectSummersibleAngle);
        Pose summersibleScorePose1 = new Pose(18,142,0);
        Pose summersibleGoScorePose1 = new Pose(17,142,0);
        Pose summersibleAlignPose2 = new Pose(60,120,collectSummersibleAngle);
        Pose summersibleCollectPose2 = new Pose(75+poscnt,99,collectSummersibleAngle);
        Pose summersibleScorePose2 = new Pose(18,142,0);
        Pose summersibleGoScorePose2 = new Pose(17,142,0);
            ...
            switch (status)
            {
                ...
                case GO_TO_COLLECT_SUMMERSIBLE:
                {
                    ...
                    if (!drive.isBusy())
                    {
                        ...
                        if (nrcicluri==3)  status = STROBOT.SWEEP_1;
                        else status = STROBOT.COLLECT_SUMMERSIBLE;
                    }
                    break;
                }
                case DETECT:
                ...
                {
                    if (Objects.equals(Retrun_Color(r.color_sensor), "yellow") || Objects.equals(Retrun_Color(r.color_sensor), "blue"))
                    {
                        leftAutoController.CurrentStatus = LeftAutoController.autoControllerStatus.TRANSFER_BEGIN;
                        globals.is_transfer_summersible = true;
                        status = STROBOT.GO_TO_SCORE_SUMMERSIBLE;
                    }
                    if (timer_failsafe.seconds() > 1.5 || Objects.equals(Retrun_Color(r.color_sensor), "red")) status = STROBOT.FAILSAFE_1;
                    break;
                }
                ...
                case FAILSAFE_2:
                {
                    ...
                    {
                        nrturn++;
                        drive.holdPoint(new BezierPoint(new Point(summersibleCollectPose1.getX(),summersibleCollectPose1.getY(),Point.CARTESIAN)),summersibleCollectPose1.getHeading()+Math.toRadians(15*nrturn*((nrturn%2==0)?-1:1)));
                        status = STROBOT.COLLECT_SUMMERSIBLE;
                    }
                    break;
                }
