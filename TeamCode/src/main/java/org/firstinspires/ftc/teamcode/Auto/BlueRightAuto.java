...
@Config
@Autonomous(group = "Auto", name = "BlueRightAuto")
...
//        Pose parkPose = new Pose(11,30,parkAngle);
        ...
        Pose preloadScorePose = new Pose(40.5   ,72,scoreAngle);
        Pose color1CollectPose = new Pose (30,34,color1CollectAngle);
        Pose color2CollectPose = new Pose (30,29,color2CollectAngle);
        Pose color3CollectPose = new Pose(30,18,color3CollectAngle);
        ...
        Pose specimen1CollectPose = new Pose(11,34,specimenCollectAngle);
        Pose specimen2AlignPose = new Pose(25,42,specimenCollectAngle);
        Pose specimen2CollectPose = new Pose(11,35,specimenCollectAngle);
        Pose specimen3AlignPose = new Pose(25,42,specimenCollectAngle);
        Pose specimen3CollectPose = new Pose(11,35,specimenCollectAngle);
        Pose specimen4AlignPose = new Pose(25,42,specimenCollectAngle);
...
//        }
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            switch (status)
            {
                ...
                {
                    if (extendopos > 20000)
                    { if (Retrun_Color(r.color_sensor) == "blue")
                    {
                        rightAutoController.CurrentStatus2 = RightAutoController.autoControllerStatus.SHORT_EXTEND;
                ...
                case PARK:
                {
                    ...
                    clawAngleController.CS = clawAngleController.clawAngleStatus.COLLECT_SPECIMEN;
