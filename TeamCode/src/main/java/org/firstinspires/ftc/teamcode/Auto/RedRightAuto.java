...
public class RedRightAuto extends LinearOpMode {
    ...
    public static double color2CollectAngle = Math.toRadians(320);
    public static double color3CollectAngle = Math.toRadians(320);
...
//        Pose parkPose = new Pose(11,30,parkAngle);
        ...
        Pose color2CollectPose = new Pose (29,26.5,color2CollectAngle);
        Pose color3CollectPose = new Pose(30,15.5,color3CollectAngle);
