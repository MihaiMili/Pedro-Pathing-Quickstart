...
public class LeftAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose summersibleScorePose1 = new Pose(19,139,0);
        Pose summersibleGoScorePose1 = new Pose(18,139,0);
...
//             FollowerConstants.holdPointTranslationalScaling = 0.25;
            switch (status)
            {
                ...
                case COLLECT_SUMMERSIBLE_CHECK:
                {
                    ...
                    if (timer_failsafe.seconds() > 0.7 || Objects.equals(Retrun_Color(r.color_sensor), "red")) status = STROBOT.FAILSAFE_1;
                    break;
                }
                ...
                case FAILSAFE_2:
                {
                    if (Objects.equals(Retrun_Color(r.color_sensor), "red")) r.collect.setPower(0.7);
