            ...
            switch (status)
            {
                ...
                case GO_TO_COLLECT_SUMMERSIBLE:
                {
                    ...
                    if (!drive.isBusy())
                    {
                        ...
                        if (nrcicluri==3)  status = STROBOT.COLLECT_SUMMERSIBLE;//status = STROBOT.SWEEP_1;
                ...
                case COLLECT_SUMMERSIBLE_CHECK:
                {
                    ...
                    if (timer_failsafe.seconds() > 1.5 || Objects.equals(Retrun_Color(r.color_sensor), "blue")) status = STROBOT.FAILSAFE_1;
                    break;
                }
